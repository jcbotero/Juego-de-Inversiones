...
const nutresaa = [
 ...
 const precioNut = ((Nutreprice) + (Nutrepriceg) + (Nutrepricei)) / 3  ; // mirar si puedo mandar asi al otro componente
  ...
  const previo = data[1];
  const noticias = data[2] // segundo escenario entonces pongo los datos [1] del objeto que nace de la array al azar
