...
const nutresaa = [
 ...
 export default function Escenario4 ({setPortaec4,setPortaBan4, setPortaCem4,setPortaNut4, setEcova, setBanva,setCemva,setNutva, cantiEco,cantiBan,cantiCem,cantiNut,  setEcova2,setBanva2,setCemva2,setNutva2, cantiEco2, cantiBan2,cantiCem2,cantiNut2, setEcova3,setBanva3,setCemva3,setNutva3, cantiEco3, cantiBan3,cantiCem3,cantiNut3,setEcova4,setBanva4,setCemva4,setNutva4, cantiEco4, cantiBan4,cantiCem4,cantiNut4   } ) { // aqui estoy recibiendo las props enviadas desde el parent App
 ...
 const precioNut = ((Nutreprice) + (Nutrepriceg) + (Nutrepricei)) / 3  ; // mirar si puedo mandar asi al otro componente
  ...
  setPortaec4(precioEco) // aqui estoy dandole valor a este hook para que tome el valor para el dinero disponible
  ...
  setPortaNut4( precioNut)



  const previo = data[2];
  const noticias = data[3] 
