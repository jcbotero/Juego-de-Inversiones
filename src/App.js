...
// revisar el code hasta ahora.. lo ultimo que hice fue cuadrar casilla del disponible, revisar
      ...
      <main id='main'>
       ...
       { cantidades === "Canti6" && < Canti6 Eco6={cantidadesEco6} Ban6={cantidadesBan6} Cem6={cantidadesCem6} Nut6={cantidadesNut6}   />}  
        ...
        <footer id='cantidades3'>
              <h3>Cuando estés listo:</h3>
              <button onClick={handleClick}> SIGUIENTE ESCENARIO</button> 
        </footer>
      </main>
    </div>
    </>
