...
export default function Resultado({setSubmittedText, sumatoria, dispo, portafo}) {
  ...
  return(
     <div className='resultados'>
         <section id='score'>
             <h3>Este es el final. Tu <span>RESULTADO</span>  es el valor actual de tu dinero disponible, sumado al valor actual de tus inversiones.</h3>
             <h2 className='tu'><span>{setSubmittedText}</span> luego de tus inversiones, la cantidad de dinero que tienes es:  </h2>
             <h2 className='tuss'>{"$" + "  " + portafolio?.toLocaleString()}</h2>
             <h4>Puedes volver a intentarlo, y así obtener un lugar dentro de los mejores puntajes.</h4>
         </section>
         <div className='mejores'> 
                <h2>MEJORES PUNTAJES:</h2>
                <button id='boton' onClick={onClickHandler}>Ver mayores puntajes</button>
                <section id='puntajes'>
                    <div>
