...
const nutresaa = [
 ...
 export default function Escenario6({props, setPortaec6,setPortaBan6, setPortaCem6,setPortaNut6, setEcova, setBanva,setCemva,setNutva, cantiEco,cantiBan,cantiCem,cantiNut,  setEcova2,setBanva2,setCemva2,setNutva2, cantiEco2, cantiBan2,cantiCem2,cantiNut2, setEcova3,setBanva3,setCemva3,setNutva3, cantiEco3, cantiBan3,cantiCem3,cantiNut3,setEcova4,setBanva4,setCemva4,setNutva4, cantiEco4, cantiBan4,cantiCem4,cantiNut4, setEcova5,setBanva5,setCemva5,setNutva5, cantiEco5, cantiBan5,cantiCem5,cantiNut5, setEcova6,setBanva6,setCemva6,setNutva6, cantiEco6, cantiBan6,cantiCem6,cantiNut6    } ) { // aqui estoy recibiendo las props enviadas desde el parent App
 ...
 const precioNut = ((Nutreprice) + (Nutrepriceg) + (Nutrepricei)) / 3  ; // mirar si puedo mandar asi al otro componente
  ...
  setEcova6(precioEco * cantiEco6)
  setPortaec6(precioEco) // aqui estoy dandole valor a este hook para que tome el valor para el dinero disponible
  ...
  setBanva6( precioBan * cantiBan6)
  setPortaBan6( precioBan)
  ...
  setCemva6( precioCem * cantiCem6)
  setPortaCem6( precioCem)
  ...
  setNutva6( precioNut * cantiNut6)
  setPortaNut6( precioNut)


  const previo = data[4];
  const noticias = data[5] 
