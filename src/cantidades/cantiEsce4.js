...
export default function Canti4(props ) {
  ...
  const [cantiEco4 , setEco] = useState(0)
  const [cantiBan4 , setBan] = useState(0) 
  const [cantiCem4 , setCem] = useState(0) 
  const [cantiNut4 , setNut] = useState(0) 
...
const  cantidadesAcci4 = () => {
 
  props.Eco4(cantiEco4) 
  props.Ban4(cantiBan4) 
  props.Cem4(cantiCem4) 
  props.Nut4(cantiNut4) 
...
const handleInput = (event) => {
 ...
 return (
   ...
   <div className='aviso'>
     ...
     <div onChange={cantidadesAcci4} className='cantidadesAcci'>
