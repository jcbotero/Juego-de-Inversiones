...
export default function Canti3( props ) {
  ...
  const [number, setNumber] = useState({one: "", two: "", three: "", four: "", five: "", six: "", seven: "", eigth: "", nine: "2000", ten: "30000", eleven: "4000", twelve: "40000", thirteen: "100000000", catorce: " ", quince: " ", dieciseis: " ", diecisiete: "" , dieciocho:"", diecinueve: "", veinte:"", veinteuno: "", veintedos: " " }) // el hook es suma ... y lo que hay dentro de usestate es el objeto que contiene ese hook
   const [cantiEco3 , setEco] = useState(0)
   const [cantiBan3 , setBan] = useState(0) 
   const [cantiCem3 , setCem] = useState(0) 
   const [cantiNut3 , setNut] = useState(0) 
 ...
 const  cantidadesAcci3 = () => {
  
   props.Eco3(cantiEco3) 
   props.Ban3(cantiBan3) 
   props.Cem3(cantiCem3) 
   props.Nut3(cantiNut3) 
...
return (
   ...
   <div className='aviso'>
     ...
     <div onChange={cantidadesAcci3} className='cantidadesAcci'>
