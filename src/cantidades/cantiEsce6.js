...
export default function Canti6(props ) {
  ...
  const [cantiEco6 , setEco] = useState(0)
  const [cantiBan6 , setBan] = useState(0) 
  const [cantiCem6 , setCem] = useState(0) 
  const [cantiNut6 , setNut] = useState(0) 
 ...
 const  cantidadesAcci6 = () => {
  
   props.Eco6(cantiEco6) 
   props.Ban6(cantiBan6) 
   props.Cem6(cantiCem6) 
   props.Nut6(cantiNut6) 
...
const handleInput = (event) => {
 ...
 <div>
   <div className='aviso'>
     ...
     <div onChange={cantidadesAcci6} className='cantidadesAcci'>
